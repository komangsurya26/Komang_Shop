...
const { verifyAccesToken, verifyAccesAdmin } = require("../middleware/verifyAccess");
...
router
  ...
  .post("/login/v1", login)
  .get("/all/v1", verifyAccesToken ,verifyAccesAdmin ,getAll)
  .get("/user/v1/:id", verifyAccesToken, getOne)
